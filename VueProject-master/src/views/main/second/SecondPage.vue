<!--<template>
    <div class="about">
        ...
        <p><button @click="init">命令1</button></p>     
        <p><button @click="init">命令2</button></p>  
        <p><button @click="init">命令3</button></p>       
        <p><button @click="init">命令4</button></p>       
        <p><button @click="init">命令5</button></p>       
        <p><button @click="init">命令6</button></p>       
        <p><button @click="init">命令7</button></p>       
        <p><button @click="init">命令8</button></p>       
        <p><button @click="init">命令9</button></p>       
    </div>
...
export default {
    ...
    methods: {
        onSubmit() {
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/A/f/0",
                {
                    // params: {
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/B/f/0",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/C/f/0",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/A/f/1",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/B/f/1",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/C/f/1",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/A/s/0",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/B/s/0",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/C/s/0",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/A/s/1",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/B/s/1",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
            ...
            this.$http
                .get("http://127.0.0.1:80/api/router/C/s/1",
                {
                    // params: {
                    //    // opr: this.activeItem.key,
                    //     params
